    ...
    >
      ...
      >
        <main className="flex flex-col items-center gap-6 w-full max-w-2xl">
          ...
          >
            Subscription <span className="text-red-500">checkout</span>
          </motion.h1>

          {/* Декоративная линия */}
          <motion.div
            className="w-24 h-1 bg-red-500 my-2"
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
          ...
          <motion.form
            ...
            className="w-full bg-black bg-opacity-60 backdrop-blur-sm rounded-xl p-6 sm:p-8 border border-red-900 shadow-lg shadow-red-900/20"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white dark:text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                <div>
                  <label htmlFor="address" className="block text-sm font-medium text-white-300 dark:text-white mb-1">
                    Address
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-4">
                ...
                <div className="pt-6">
                  <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg border border-gray-700">
                    ...
                    <span className="text-xl font-bold text-red-400">999 ₸</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Link href="/tariffs/thanksto" passHref className="w-full sm:w-auto flex-1 min-w-[200px]"/>
            <motion.button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-red-600 to-rose-500 text-white dark:text-white font-bold rounded-lg shadow-lg hover:opacity-90 transition-opacity"
